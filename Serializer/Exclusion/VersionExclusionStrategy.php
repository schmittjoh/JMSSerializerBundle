...
class VersionExclusionStrategy implements ExclusionStrategyInterface
{
    ...
    public function shouldSkipClass(ClassMetadata $metadata, $depth, $object = null)
    {
        return false;
    }
     ...
     * {@inheritDoc}
     */
    public function shouldSkipProperty(PropertyMetadata $property, $depth, $object = null)
    {
