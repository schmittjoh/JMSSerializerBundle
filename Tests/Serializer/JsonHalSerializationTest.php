...
class JsonHalSerializationTest extends BaseSerializationTest
{
    protected function getContent($key)
    {
        ...
        if (!$outputs) {
            ...
            $outputs['blog_post'] = '{"title":"This is a nice title.","created_at":"2011-07-30T00:00:00+0000","is_published":false,"_embedded":{"comments":[{"_embedded":{"author":{"full_name":"Foo Bar"}},"text":"foo"}],"author":{"full_name":"Foo Bar"}}}';
            ...
            $outputs['form_errors'] = '[{"message_template":"This is the form error","_embedded":{"message_parameters":[]}},{"message_template":"Another error","_embedded":{"message_parameters":[]}}]';
            $outputs['nested_form_errors'] = '[{"message_template":"This is the form error","_embedded":{"message_parameters":[]}},{"message_template":"Another error","_embedded":{"message_parameters":[]}}]';
            ...
            $outputs['input'] = '{"_embedded":{"attributes":{"type":"text","name":"firstname","value":"Adrien"}}}';
    ...
    // Tests that require Deserialization
    ...
    // Tests where the unit tests are currently broken. They need to be investigated. Their output needs to be adjusted.
